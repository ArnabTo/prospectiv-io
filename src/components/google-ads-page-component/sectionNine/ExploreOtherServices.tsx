    ...
    return (
        <section className='max-w-7xl mx-auto space-y-8 p-5'>
            ...
            <motion.div
                ...
                viewport={{ once: true }}
                className='flex flex-col md:flex-row h-full gap-5 lg:max-w-[60%] justify-center items-start mx-auto'>
                <div className='bg-card md:max-w-[50%] border border-borderColor rounded-2xl p-5 shadow-black hover:shadow-2xl flex-grow flex flex-col gap-5 group'>
                ...
                <div className='bg-card md:max-w-[50%] h-full border border-borderColor rounded-2xl p-5 shadow-black hover:shadow-2xl flex-grow flex flex-col gap-5 group'>
                    <Link href='/services/google-ads'>
                        <div className='h-52 bg-gradient-to-tr from-gradientColorOne via-[#b372ce] to-[#ff7586] rounded-xl overflow-hidden mb-5'>
                            <Image
                                src={ColdEmail}
