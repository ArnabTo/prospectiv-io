        ...
        <>
            <AnimatePresence>
                ...
                {showBlackScreen && (
                        ...
                        className="blur-[100px] w-full max-w-[44%] min-h-[74%] fixed -top-60 -left-24 lg:-left-52 z-50 animate-spin-slow transition-all">
            ...
            <AnimatePresence>
                {showText && (
                    <motion.div
                        ...
                        className="fixed bottom-8 left-0 w-full h-full z-50 flex items-end justify-center"
                    >
                        <CountUp
                            start={0}
                            end={100}
