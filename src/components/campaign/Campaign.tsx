    ...
    <div className="lg:max-w-[80%] mx-auto bg-card flex flex-col lg:flex-row items-center gap-5 p-5 lg:p-10 rounded-3xl relative z-10 border border-borderColor">
        ...
        <div className="w-full flex flex-col lg:flex-row justify-center items-center gap-4">
            ...
            <div className="w-full flex rounded-full mx-auto shadow-lg duration-300 transform group-hover:scale-105">
                <Link href="" className="flex-1 font-semibold text-lg bg-buttonColor text-textColorOne text-center lg:px-10 py-5 rounded-full hover:bg-buttonHoverColor transition-all duration-300">
                    See Our Pricing
                </Link>
            </div>
        </div>
