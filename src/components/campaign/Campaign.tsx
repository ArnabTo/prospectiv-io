...
const Campaign = () => {
    return (
        <div className="relative max-w-7xl px-5 mx-auto py-24">
            ...
            <div className="lg:max-w-[80%] mx-auto bg-card flex flex-col lg:flex-row items-center gap-5 p-5 lg:p-10 rounded-3xl relative z-10 border border-borderColor">
                ...
                <Link href="" className="flex-1 font-semibold text-lg bg-buttonColor text-textColorOne text-center lg:px-10 py-5 rounded-full hover:bg-buttonHoverColor hover:scale-95 transition-all duration-300">
                    See Our Pricing
                </Link>
            </div>
                </div>
