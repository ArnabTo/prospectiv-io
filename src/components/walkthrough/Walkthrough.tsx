...
const Walkthrough = () => {
    ...
    const animateTriggerRefOne = useRef(null);
    const animateTriggerRefTwo = useRef(null);
    ...
    useEffect(() => {
        ...
        const tl = gsap.timeline({
            scrollTrigger: {
                trigger: animateTriggerRefOne.current,
                start: 'top 80%',
    ...
    useEffect(() => {
        ...
        const tl = gsap.timeline({
            scrollTrigger: {
                trigger: animateTriggerRefTwo.current,
                start: 'top 80%',
                // toggleActions: 'play none none none',
                // markers: true,
            }
            ...
            <div className='max-w-7xl mx-auto p-5 space-y-36 lg:pt-32 lg:pb-32'>
                ...
                {/* paid advertising walkthrough */}
                    <div className='relative' >
                        <h2 ref={animateTriggerRefOne} className='text-3xl md:text-4xl lg:text-5xl text-center lg:text-left font-semibold mb-16'>Paid Advertising Walkthrough</h2>
                        <div className='w-full space-y-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-300 before:to-transparent'>
                            <div className='relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse gap-2 lg:gap-0 group'>
                                ...
                                {/* Card */}
                                <div ref={CardOneRef}
                                    className="cardOneDiv w-full md:w-[calc(50%-2.5rem)] bg-card p-4 lg:p-8 border border-borderColor shadow rounded-3xl space-y-5">
                ...
                <div className='relative' >
                    <h2 ref={animateTriggerRefTwo} className='text-3xl md:text-4xl lg:text-5xl text-center lg:text-left font-semibold mb-16'>Cold Email Walkthrough</h2>
                    <div className='w-full space-y-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-300 before:to-transparent'>
                        <div className='relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse gap-2 lg:gap-0 group'>
                            {/* Icon */}
                            <div className="flex items-center justify-center w-10 h-10 rounded-full border border-white bg-slate-300 group-[.is-active]:bg-emerald-500 text-slate-500 group-[.is-active]:text-emerald-50 shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2">
                        ...
                        <div className='relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse gap-2 lg:gap-0 group'>
                            ...
                            {/* Card */}
                            <div ref={CardSixRef} className="w-full md:w-[calc(50%-2.5rem)] bg-card p-4 lg:p-8 border border-borderColor shadow rounded-3xl">
