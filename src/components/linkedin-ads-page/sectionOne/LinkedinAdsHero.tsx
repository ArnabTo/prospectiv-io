                                ...
                                <div className="relative min-w-[50%] h-full md:p-5">
                                    <div
                                        ...
                                        {heroContents[0]?.bannerImageOne && (
                                            <Image
                                                className="w-full max-w-[15%] mx-auto rounded-[10px] lg:rounded-xl border bg-card border-borderColor animate-floatReverse z-20 -mr-5 md:-mr-8 lg:-mr-10 "
...
export default LinkedinAdsHero;